        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start space-y-4 md:space-y-6 text-center md:text-left">
            ...
            <h2 className="text-base sm:text-lg md:text-xl lg:text-2xl font-medium text-gray-700 dark:text-gray-300 dark:hover:text-white">
              {t('hero.role')}{' '}
              <Link href="/contact">
                <span className="text-blue-600 hover:text-green-300">
            ...
            <div className="flex justify-center md:justify-start space-x-4 sm:space-x-5 pt-2 md:pt-4">
              ...
              <Link
                href="https://linkedin.com/in/fleizean"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <Link
                href="https://youtube.com/@fleizean"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <Link
                href="https://profile.intra.42.fr/users/eyagiz"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-2 sm:gap-0 mt-6">
              ...
              <div className="flex items-center">
                [
                <Link href="/contact">
                  <button className="text-gray-700 hover:text-blue-600 font-medium transition-colors duration-200 dark:text-gray-300 dark:hover:text-blue-600 cursor-pointer">
          ...
          <div className="w-full md:w-1/2 flex justify-center md:justify-end mt-6 md:mt-0">
            <div
              className={`relative w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-72 lg:h-72 xl:w-80 xl:h-80 overflow-hidden border-4 shadow-lg group glitch-container ${isGlitching ? 'glitch-active' : ''}`}
            >
              <Image
                src={heroImage}
                alt="{t('hero.imageAlt')}"
