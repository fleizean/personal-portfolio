                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:nsyagz@gmail.com" className="text-black hover:text-black dark:text-gray-300 dark:hover:text-white font-medium transition-colors">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="https://www.google.com/maps/place/Kocaeli,+Turkey" target="_blank" rel="noopener noreferrer" className="text-black hover:text-black dark:text-gray-300 dark:hover:text-white font-medium transition-colors">
