...
const ProjectsContent: React.FC = () => {
  ...
  const presentProjects =
    (t('projects.items.present', { returnObjects: true }) as ProjectItem[]) || [];
  ...
  const getStatusBadge = (status: ProjectItem['status']) => {
    switch (status) {
      case 'development':
        return (
          <span className="bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-yellow-900/30 dark:text-yellow-300">
            In Development
          </span>
        );
      case 'completed':
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-20 xl:px-60">
        ...
        <div className="mb-8">
          <h3 className="font-bold mb-4 dark:text-gray-300 dark:hover:text-white">
            {t('projects.present_section_title')}
          </h3>
                  ...
                  <div className="flex items-baseline gap-2 flex-grow">
                    ...
                    <div className="w-full">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="font-xs text-gray-800 dark:text-gray-400">
                          • {project.year}
                        </span>
                      ...
                      {project.techStack && (
                        <div className="flex flex-wrap gap-1 mt-2">
                          {project.techStack.map((tech, techIndex) => (
                            <span
                              key={techIndex}
                              className="bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300 text-xs px-2 py-0.5 rounded"
                            >
                              {tech}
                            </span>
                          ))}
