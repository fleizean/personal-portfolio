        ...
        <div className="flex flex-row justify-between items-center container mx-auto px-4 sm:px-6 md:px-8 lg:px-20 xl:px-60">
            <nav className="flex items-center justify-between w-full py-4">
                ...
                <div className="hidden md:flex items-center">
                    ...
                    <div className="flex items-center">
                        <Link href="/blog" className="text-gray-700 hover:text-black no-underline font-medium transition-colors dark:text-gray-300 dark:hover:text-white hover:underline">
