...
const MusicPlayer: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-sm mx-auto px-4 py-3 rounded-lg border transition-all duration-300 bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700">
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-gray-800 dark:text-gray-200 font-medium text-xs truncate">
            {currentTrack === '/music/24.mp3'
              ? 'Chopin - Nocturne Op. 48 No. 1'
              : 'Mr. Robot - 1.0_8-whatsyourask.m4p'}
          </div>
        </div>
