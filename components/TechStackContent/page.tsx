                ...
                {frontendItems.map((item, index) => (
                    ...
                    <div className="flex items-start gap-2">
                        ...
                        <div className="flex flex-wrap items-center gap-1">
                            <span className="font-xs dark:text-gray-300">{item.name}</span>
                            <span className="font-medium text-black dark:text-gray-300">
                            <Link href={item.link || '#'} target="_blank" rel="noopener noreferrer" className="text-black hover:text-gray-500 dark:text-gray-300 dark:hover:text-white">
                                
                            </Link>
                            </span>
                        </div>
                        <p className="text-xs sm:text-sm text-gray-500 mt-1 dark:text-gray-400">{item.description}</p>
                        </div>
                    </div>
                    </li>
                ))}
